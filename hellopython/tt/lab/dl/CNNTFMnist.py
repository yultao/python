...
class CNNTFMnist():
    ...
    def forward_propagation_for_predictwwwww(self, X, parameters):
        """
...
#     Y_test shape: (120, 6)
    def processData(self, X_train_orig,Y_train_orig,X_dev_orig, Y_dev_orig,X_test_orig, Y_test_orig):
...
#     cost = 2.91034
    def test_compute_cost(self):
        ...
        with tf.Session() as sess:
            ...
            print("cost = " + str(a))
    def test_model(self, X_train, Y_train, X_test, Y_test, learning_rate, minibatch_size, num_epochs):
...
#     tc.showImg(X_train_orig,Y_train_orig);
    X_train,Y_train,X_dev,Y_dev,X_test,Y_test = tc.processData(X_train_orig,Y_train_orig,
...
#     tc.test_compute_cost();
    for lr in [0.005]:
        for mb in [64]:
            print(str(lr)+", "+str(mb))
            tc.test_model(X_train, Y_train, X_dev, Y_dev,learning_rate = lr,num_epochs = 50, minibatch_size = mb);